...
/** 每一行的最大列数 */
static const int KXDefaultMaxColumns = 3;
/** 每一行的间距 */
static const CGFloat KXDefaultRowMargin = 10;
/** 每一列的间距 */
static const CGFloat KXDefaultColumnMargin = 10;
/** 上下左右的间距 */
static const UIEdgeInsets KXDefaultInsets = {10, 10, 10, 10};

@interface KXWaterFlowLayout()
/** 存放每一列的最大Y值(整体高度) */
@property (nonatomic, strong) NSMutableArray *maxYs;
@property (nonatomic, strong) NSMutableArray *attrsArray;
@end

@implementation KXWaterFlowLayout
